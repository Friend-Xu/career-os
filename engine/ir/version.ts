...
/** 引擎支持的协议版本（已发布全集：2.0 旧记录无 profile；2.1 profile 必填；2.2 Job Intelligence；2.3 Evidence Inventory；2.8 Decision Payload 结构化） */
export const SUPPORTED_VERSIONS = ['2.0', '2.1', '2.2', '2.3', ProtocolVersion] as const
